...
- maxWidth: Length, Describes the maximum distance between the two end points of the guy wire relative to the ground. Consider the ground as the xy plane, the maximum width is then the length between the two end points in the xy plane.
