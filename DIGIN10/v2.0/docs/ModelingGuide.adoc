...
. Object [red]#Reference/Registry# (OR)
...
=== [red]#Switch#
Switch.locked is mandatory for [red]#CGMES 3.0/CIM100# compliance. It is currently not included in the DIGIN10 model and will be implemented in a later version.
