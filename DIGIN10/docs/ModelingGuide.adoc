...
=== Measurement 
Please refer to xref:ModelingGuide_Measurement.adoc#MG_Me[ModelingGuide_Measurement.adoc] for details.

=== MeterReading
Please refer to xref:ModelingGuide_MeterReading.adoc#MG_MR[ModelingGuide_MeterReading.adoc] for details.
