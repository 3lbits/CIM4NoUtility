...
Feeder is not part of CGMES v3.0, but added to CIM17 and CDPSM. Upcoming version will include the Feeder and Fuse with the recommended way to model it. 
