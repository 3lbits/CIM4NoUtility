configCuCim17 = \
    {
        'cim:UsagePoint': {
            ...
            'tags': {
                ...
                'cim:UsagePoint.nominalServiceVoltage': {'type': 'float', 'list': False},
                'cim:UsagePoint.outageRegion': {'type': 'string', 'list': False},
                'cim:UsagePoint.phaseCount': {'type': 'int', 'list': False},
                'cim:UsagePoint.ratedCurrent': {'type': 'float', 'list': False},
                'cim:UsagePoint.ratedPower': {'type': 'float', 'list': False},
