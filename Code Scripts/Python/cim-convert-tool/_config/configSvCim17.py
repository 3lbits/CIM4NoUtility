configSvCim17 = \
    {
        'cim:SvPowerFlow': {
            ...
            'tags': {
                'cim:SvPowerFlow.p': {'type': 'float', 'list': False},
                'cim:SvPowerFlow.q': {'type': 'float', 'list': False}
            },
            'attributes': {
        ...
        'cim:SvVoltage': {
            ...
            'tags': {
                'cim:SvVoltage.angle': {'type': 'float', 'list': False},
                'cim:SvVoltage.v': {'type': 'float', 'list': False}
            },
            'attributes': {
