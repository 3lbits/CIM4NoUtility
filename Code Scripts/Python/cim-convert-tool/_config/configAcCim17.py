configAcCim17 = \
    {
        'cim:CableInfo': {
            ...
            'tags': {
                ...
                'cim:WireInfo.coreRadius': {'type': 'float', 'list': False},
                'cim:WireInfo.coreStrandCount': {'type': 'int', 'list': False},
                'cim:WireInfo.gmr': {'type': 'float', 'list': False},
                'cim:WireInfo.insulated': {'type': 'bool', 'list': False},
                'cim:WireInfo.insulationThickness': {'type': 'float', 'list': False},
                'cim:WireInfo.rAC25': {'type': 'float', 'list': False},
                'cim:WireInfo.rAC50': {'type': 'float', 'list': False},
                'cim:WireInfo.rAC75': {'type': 'float', 'list': False},
                'cim:WireInfo.rDC20': {'type': 'float', 'list': False},
                'cim:WireInfo.radius': {'type': 'float', 'list': False},
                'cim:WireInfo.ratedCurrent': {'type': 'float', 'list': False},
                'cim:WireInfo.sizeDescription': {'type': 'string', 'list': False},
                'cim:WireInfo.strandCount': {'type': 'int', 'list': False},
                'cim:CableInfo.diameterOverCore': {'type': 'float', 'list': False},
                'cim:CableInfo.diameterOverInsulation': {'type': 'float', 'list': False},
                'cim:CableInfo.diameterOverJacket': {'type': 'float', 'list': False},
                'cim:CableInfo.diameterOverScreen': {'type': 'float', 'list': False},
                'cim:CableInfo.isStrandFill': {'type': 'bool', 'list': False},
                'cim:CableInfo.nominalTemperature': {'type': 'float', 'list': False},
        ...
        'cim:ProductAssetModel': {
            ...
            'tags': {
                ...
                'cim:ProductAssetModel.weightTotal': {'type': 'float', 'list': False}
            },
            'attributes': {
        ...
        'cim:AssetModelCatalogueItem': {
            ...
            'tags': {
                ...
                'cim:IdentifiedObject.name': {'type': 'string', 'list': False},
                # 'cim:IdentifiedObject.shortName': {'type': 'string', 'list': False},
                'cim:AssetModelCatalogueItem.unitCost': {'type': 'decimal', 'list': False}
            },
            'attributes': {
