configOpCim17 = \
    {
        ...
        'cim:CurrentTransformer': {
            ...
            'tags': {
                ...
                'cim:CurrentTransformer.coreBurden': {'type': 'float', 'list': False, 'CIMDatatype': 'cim:ActivePower.value'},
        ...
        'cim:RemoteSource': {
            ...
            'tags': {
                ...
                'cim:RemoteSource.scanInterval': {'type': 'float', 'list': False, 'CIMDatatype': 'cim:Seconds.value'},
